...
export default function CaseStudy1() {
  ...
  return (
    <section className="bg-grey-900 text-gray-800">
      ...
      {/* Content Section */}
      <section className="max-w-6xl mx-auto px-6 py-16 text-gray-900">
  {/* Top Court Statement */}
  <div className="text-center md:text-left mb-12">
    ...
    <p className="text-[15px] text-gray-700 mt-3 max-w-4xl">
  ...
  <div className="grid md:grid-cols-2 gap-10 items-start mt-10">
    ...
    <div>
      ...
      <p className="text-gray-700 mb-4 leading-relaxed text-[15px]">
        Aqueous film forming foam, generally known as AFFF, is a type of
        firefighting foam used to put out liquid fuel fires. It’s water blended
        with a concentrate.
      </p>
      <p className="text-gray-700 leading-relaxed text-[15px]">
        Using foam to put out fires spread like wildfire in the 1960s. In the
        1970s, the Department of Defence first used it on military installations.
        Since then, it has been utilised by both military and civilian firemen
        for decades in training and fire suppression.
      </p>
    </div>
  </div>
  ...
  <div className="mt-16">
    <h3 className="text-lg md:text-xl font-semibold mb-4 text-gray-900">
      The EPA and the Agency for Toxic Substances and Disease Registry have
      connected PFAS to a number of health issues, including:
    </h3>
    ...
    <ul className="list-disc pl-5 space-y-2 text-gray-800 text-[15px] leading-relaxed">
      ...
      <li>
        Increased chance of renal and testicular cancer among other cancers
      </li>
              ...
              <AnimatePresence>
                {openIndex === index && (
                  <motion.div
                    ...
                    className="bg-gray-50 px-6 py-4 text-gray-700 text-[15px] space-y-3 leading-relaxed"
